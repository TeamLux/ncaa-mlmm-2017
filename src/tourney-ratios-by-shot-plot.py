...
with open('./data/TourneyDetailedResults.csv') as csv:
...
pyplot.title('Tourney - Field Shot Ratio')

pyplot.savefig('./plots/tourney-field-shot-ratio-plot.png', bbox_inches='tight')
...
pyplot.title('Tourney - Three Pointer Ratio')

pyplot.savefig('./plots/tourney-three-pointer-ratio-plot.png', bbox_inches='tight')
...
pyplot.title('Tourney - Free Shot Ratio')

pyplot.savefig('./plots/tourney-free-shot-ratio-plot.png', bbox_inches='tight')
